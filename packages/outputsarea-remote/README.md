# fails_components_jupyter_outputsarea_remote
...
```bash
pip install fails_components_jupyter_outputsarea_remote
```
...
```bash
pip uninstall fails_components_jupyter_outputsarea_remote
```
